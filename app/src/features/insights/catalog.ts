...
export const features = {
  tools: {
    ...
    es: {
      ...
      caveat: 'Esta actividad muestra ejecuciones observadas, no pensamiento privado. Las tools consultan información u ofrecen opciones de contacto; ninguna envía correos.',
    ...
    en: {
      ...
      caveat: 'This activity shows observed executions, not private thinking. Tools retrieve information or offer contact choices; none sends email.',
