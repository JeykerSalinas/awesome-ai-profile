...
from agents.tools import build_search_documents_tool, get_candidate_photo, get_profile_section, search_experience, offer_contact
...
def get_agent(locale: SupportedLocale = "en", document_ids: list[str] | None = None):
    ...
    return create_agent(
        model=model,
        tools=[get_candidate_photo, get_profile_section, search_experience, build_search_documents_tool(document_ids), offer_contact],
